...
entry_per_date <- process_counts_per_feature(data_vis,"eventDate","gbifID")
entry_per_date <- process_counts_per_feature(data_vis,"year","gbifID")
entry_per_date <- process_counts_per_feature(data_vis,"month","gbifID")
entry_per_date <- process_counts_per_feature(data_vis,"day","gbifID")
...
# species per month
spp_per_month <- process_counts_per_feature(data_vis, "month", "species")
# spp_per_month_norm # ???

ggplot(spp_per_month, aes(month , y = total_count, color = species)) +
  geom_line() +
  # geom_point() +
  # theme(legend.position="none") +
