...
# test$stateProvince[test$stateProvince=="",]<- cities_list$stateProvince[match(test$locality, cities_list$locality)]

state_provences <- character(nrow(test))
# time-consuming step (parallelize?)
...
test$stateProvince <- state_provences
