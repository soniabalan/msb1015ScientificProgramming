...
# }
# 
# # Parallelize the loop (still takes a lot of time)
...
# save to easily access the cleaned data when you want to skip the time-consuming step of getting the province data
...
# Diagnostics Plots -------------------------------
  Cutoff Decision
```{r}
data <- read.csv("data_filled_gaps.csv",
                 header=TRUE,
