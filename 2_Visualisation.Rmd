...
ggplot(data = div_per_prov, aes(x = decimalLongitude, y = decimalLatitude)) +
  geom_point(aes(size = richness_index.x, 
                 color = richness_index.x)) +  # Use size for shannon_index values
...
ggplot(data = div_per_prov, aes(x = decimalLongitude, y = decimalLatitude)) +
  geom_point(aes(size = simpson_index.x, 
                 color = simpson_index.x)) +  # Use size for shannon_index values
  # If you want to use fill instead of size, you can use aes(fill = shannon_index)
...
ggplot(data = div_per_prov, aes(x = decimalLongitude, y = decimalLatitude)) +
  geom_point(aes(size = shannon_wiener_index.x, 
                 color = shannon_wiener_index.x)) +  # Use size for shannon_index values
  # If you want to use fill instead of size, you can use aes(fill = shannon_index)
...
ggplot(data = div_per_prov, aes(x = decimalLongitude, y = decimalLatitude)) +
  geom_point(aes(size = richness_index.y, 
                 color = richness_index.y)) +  # Use size for shannon_index values
  # If you want to use fill instead of size, you can use aes(fill = shannon_index)
...
ggplot(data = div_per_prov, aes(x = decimalLongitude, y = decimalLatitude)) +
  geom_point(aes(size = simpson_index.y, 
                 color = simpson_index.y)) +  # Use size for shannon_index values
  # If you want to use fill instead of size, you can use aes(fill = shannon_index)
...
ggplot(data = div_per_prov, aes(x = decimalLongitude, y = decimalLatitude)) +
  geom_point(aes(size = shannon_wiener_index.y, 
                 color = shannon_wiener_index.y)) +  # Use size for shannon_index values
  # If you want to use fill instead of size, you can use aes(fill = shannon_index)
...
ggplot(data = div_per_prov, aes(x = decimalLongitude, y = decimalLatitude)) +
  geom_point(aes(size = richness_index, 
                 color = richness_index)) +  # Use size for shannon_index values
  # If you want to use fill instead of size, you can use aes(fill = shannon_index)
...
ggplot(data = div_per_prov, aes(x = decimalLongitude, y = decimalLatitude)) +
  geom_point(aes(size = simpson_index, 
                 color = simpson_index)) +  # Use size for shannon_index values
  # If you want to use fill instead of size, you can use aes(fill = shannon_index)
...
'SHANON-WIENER INDEX '
p <- ggplot(data = div_per_prov, aes(x = decimalLongitude, y = decimalLatitude)) +
  geom_point(aes(size = shannon_wiener_index, 
                 color = shannon_wiener_index)) +  # Use size for shannon_index values
  # If you want to use fill instead of size, you can use aes(fill = shannon_index)
...
ggplot(data = div_per_prov,
  ...
  annotation_raster(img,
                    xmin = min(div_per_prov$decimalLongitude)-1.75,
                    xmax = max(div_per_prov$decimalLongitude)+2.3,
                    ymin = min(div_per_prov$decimalLatitude)-0.5,
                    ymax = max(div_per_prov$decimalLatitude)+0.5) + 
  geom_point(aes(size = shannon_wiener_index, 
                 color = shannon_wiener_index)) +  # Use size for shannon_index values
  # If you want to use fill instead of size, you can use aes(fill = shannon_index)
  labs(title = "Shannon-Wiener Index (Species)", x = "Decimal Longitude", y = "Decimal Latitude") +
  xlim(min(div_per_prov$decimalLongitude)-1, max(div_per_prov$decimalLongitude)+0.5)+
  ylim(min(div_per_prov$decimalLatitude)-0.5, max(div_per_prov$decimalLatitude)+0.25)+
  geom_text(aes(x = decimalLongitude,
                y = decimalLatitude,
                label = stateProvince),
            size = 3, 
...
Redo figs by shannon_index, instead of counts of birds
